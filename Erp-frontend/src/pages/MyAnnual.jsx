    ...
    return(
      ...
      `}
            ...
            <div className='px-10 py-4 flex flex-wrap gap-6 overflow-y-scroll scrollbar-hidden h-[calc(100vh-5rem-5rem)]'>
                ...
                {list.length === 0
                    ? (<p className='ml-5 mt-2 text-xs text-[#1a1a1a] flex items-start justify-start'>Your Annual vacations list is empty !</p>)
                    : list.map((vacation, index) => (
                        <MyAnnualCart id= {vacation._id} employee= {vacation.empName} department= {vacation.departmet}
            ...
            {isRequirementModal && <VacationAnnualAdd setIsRequirementModal = {setIsRequirementModal} />}
