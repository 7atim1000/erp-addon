...
import { MdSecurity, MdAccessibility, MdStore, MdPointOfSale } from "react-icons/md";
...
const Auth = () => {
    ...
    return (
        <div className="flex h-screen w-full bg-gradient-to-br from-blue-50 via-white to-blue-50">
            
            {/* Left Section - Features */}
            <div className="hidden xl:flex xl:w-1/2 relative p-4 md:p-8 lg:p-12 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800">
                <div className="w-full h-full max-w-4xl rounded-3xl overflow-hidden shadow-2xl transform transition-all duration-500 border-4 border-white/20 relative bg-white/5 backdrop-blur-sm">
                    ...
                    {/* Content */}
                    <div className="absolute inset-0 flex flex-col justify-center p-8 md:p-10 lg:p-12">
                        <div className="relative z-10">
                            {/* Logo */}
                            <div className="mb-6">
                                <div className="inline-flex items-center justify-center bg-white/20 rounded-2xl p-3 backdrop-blur-sm">
                                    <GiPerpendicularRings className="h-12 w-12 text-white" />
                                </div>
                            </div>
                            ...
                            <p className="text-base md:text-lg lg:text-xl text-blue-100 mb-8 leading-relaxed">
                                Complete Point of Sale & Business Management Solution
                            </p>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-3">
                                    <div className="bg-white/20 rounded-lg p-2">
                                        <MdStore className="h-5 w-5 text-white" />
                                    </div>
                                    <div>
                                        <h3 className="text-white font-semibold">Retail Management</h3>
                                        <p className="text-blue-100 text-sm">Complete retail operations control</p>
                                    </div>
                                </div>
                                
                                <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-3">
                                    <div className="bg-white/20 rounded-lg p-2">
                                        <MdPointOfSale className="h-5 w-5 text-white" />
                                    </div>
                                    <div>
                                        <h3 className="text-white font-semibold">POS Integration</h3>
                                        <p className="text-blue-100 text-sm">Seamless point of sale experience</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-blue-100 text-sm">Live sales and inventory tracking</p>
                                    </div>
                                </div>
            ...
            <div className="w-full xl:w-1/2 flex flex-col items-center justify-center p-3 sm:p-4 md:p-6 lg:p-8">
                <div className="w-full max-w-xs sm:max-w-sm md:max-w-md bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-4 sm:p-6 md:p-8 border border-gray-100">
                    
                    {/* Logo Section */}
                    <div className="flex flex-col items-center gap-3 mb-6">
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full blur opacity-30"></div>
                            <div className="relative bg-gradient-to-r from-blue-500 to-blue-600 rounded-full p-2 sm:p-3 shadow-lg">
                                <GiPerpendicularRings className="h-12 w-12 sm:h-14 sm:w-14 text-white" />
                            </div>
                        </div>
                        ...
                        <div className="inline-flex items-center justify-center gap-2 sm:gap-3 mb-3">
                            <div className="bg-blue-50 p-2 rounded-full">
                                {isRegister ? (
                                    ...
                                    <FaSignInAlt className="h-5 w-5 text-blue-600" />
                                )}
                            </div>
                    ...
                    <div className="border-t border-gray-100 pt-4">
                        <div className="text-center">
                            ...
                            <button
                                ...
                                className="group inline-flex items-center justify-center gap-2 text-blue-600 hover:text-blue-700 font-semibold text-sm transition-all duration-200 bg-blue-50 hover:bg-blue-100 rounded-lg px-5 py-2.5 w-full"
                            >
                                <span>{isRegister ? "Sign in instead" : "Create account"}</span>
                                <FaArrowRight className="h-3 w-3 transform transition-transform duration-200 group-hover:translate-x-1" />
                            </button>
                        </div>
                    </div>
                </div>
                ...
                {/* Mobile Features */}
                <div className="xl:hidden w-full max-w-xs sm:max-w-sm md:max-w-md mt-6">
                    <div className="grid grid-cols-2 gap-3">
                        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-3 text-center">
                            <MdStore className="h-5 w-5 text-blue-600 mx-auto mb-2" />
                            <p className="text-xs font-medium text-gray-700">Retail</p>
                        </div>
                        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-3 text-center">
                            <MdPointOfSale className="h-5 w-5 text-blue-600 mx-auto mb-2" />
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-3 text-center">
                            <FaShieldAlt className="h-5 w-5 text-blue-600 mx-auto mb-2" />
