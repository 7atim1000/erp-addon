...
import { MdChevronLeft, MdChevronRight, MdAttachMoney } from "react-icons/md";
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3 sm:gap-4">
                            <div className="bg-white/20 p-2 sm:p-2.5 rounded-lg">
                                <MdAttachMoney className="text-white w-5 h-5 sm:w-6 sm:h-6" />
                            </div>
                            <div>
                                <h2 className='text-lg sm:text-xl font-bold text-white'>Customer Statement</h2>
                                <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-blue-100 text-xs sm:text-sm">
                                    <span className="font-medium">Customer: {customerData.customerName}</span>
                                    <span className="hidden sm:inline">•</span>
                                    <span>Balance: {customerData.balance} AED</span>
                                </div>
                            </div>
                        </div>
