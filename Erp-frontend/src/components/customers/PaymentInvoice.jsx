...
import { FaPrint, FaTimes, FaReceipt, FaUser, FaMoneyBillWave, FaSignature } from "react-icons/fa";
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-4 sm:p-5 flex-shrink-0">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className='text-lg sm:text-xl font-bold text-white'>Payment Receipt</h2>
                ...
                <div className='flex-1 overflow-y-auto p-4 sm:p-5'>
                    <div ref={invoiceRef} className='bg-white rounded-xl border border-blue-200 p-4 sm:p-5 
                        ...
                        <div className='text-center mb-6'>
                            ...
                            <h2 className='text-xl sm:text-2xl font-bold text-blue-700 mb-1'>PAYMENT RECEIPT</h2>
                            ...
                            <div className="bg-blue-50 rounded-lg p-3 sm:p-4">
                                ...
                                <div className="space-y-1 text-sm">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium text-gray-800">{paymentInfo.customerName}</span>
                                    </div>
                                    <div className="flex justify-between">
                            ...
                            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-3 sm:p-4 border border-green-200">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-600 text-xs mt-2">
                                        This transaction has been processed and recorded
                                    </p>
                                </div>
                            </div>
                        </div>
