...
const ReceiptInvoice = ({receiptInfo, setShowInvoice}) => {
        ...
        <div className ='fixed inset-0 bg-opacity-50 flex justify-center items-center' style={{ backgroundColor: 'rgba(20, 10, 10, 0.4)' }} >
            <div className = 'bg-white p-4 rounded-lg shadow-lg  w-[400px]'>
                ...
                <div ref ={invoiceRef} className ='p-4'>
                    ...
                    <h2 className ='text-xl font-bold text-center mb-2'>Receipt Invocie</h2>
                    <p className ={`text-center text-gray-600`}>Thank you for your order</p>
                    
                    {/*Order Details*/}
                    <div className ='mt-4 border-t pt-4  text-sm text-gray-700'>
                        <p className ='text-xs font-semibold text-sky-600 mb-3 underline'>{ new Date(receiptInfo.invoiceDate).toLocaleDateString('en-GB')}</p>
                        
                        <p>
                            <strong>Invoice Number : </strong>
                            {receiptInfo.storeinvoiceNumber} 
                        </p>
                        <p>
                            <strong>Name: </strong> {receiptInfo.supplierName} 
                        </p>
                        <p>
                            <strong>Phone: </strong> {receiptInfo.supplierDetails.phone} 
                        </p>    
                        {/* <p>
                    ...
                    <div className ={`mt-4 border-t pt-4 text-sm`}>
                        <p className ='flex gap-1'>
                            ...
                            <span className ='text-xs font-semibold'>{receiptInfo.bills.total.toFixed(2)}</span>  
                        </p>
