...
import { addStore } from '../../https';
import{ useSelector } from 'react-redux';

const AddStoreModal = ({setIsAddStoreModal}) => {
    ...
    const [formData, setFormData] = useState({
        storeName: "" , storeNo :`${Date.now()}`, user: userId, storeLocation: "" 
    });
    ...
    const storeMutation = useMutation({
        mutationFn: (reqData) => addStore(reqData),
        onSuccess: (res) => {
        ...
        <div className='fixed inset-0 bg-opacity-50 flex items-center justify-center shadow-lg/10 z-50' style={{ backgroundColor: 'rgba(20, 10, 10, 0.4)' }}>
            ...
            >
                ...
                <div className="flex justify-between items-center mb-2 shadow-xl p-2">
                    <h2 className='text-[#1a1a1a] text-md font-bold'>Add Store</h2>
                ...
                <form className='mt-3 space-y-6' onSubmit={handleSubmit}>
                    <div className='mt-5'>
                        ...
                        <label className='w-[20%] text-[#1a1a1a] block mb-2 mt-3 text-xs font-normal'>Store Name :</label>
                        ...
                        <div className='flex items-center justify-between'>
                        <label className='w-[20%] text-[#1a1a1a] block mb-2 mt-3 text-xs font-normal'>Location :</label>
