...
const VacationSickleaveAdd = ({setIsRequirementModal}) => {
    ...
    // Function to get today's date in dd-yyyy format
    // const getTodayDate = () => {
    ...
    const [formData, setFormData] = useState({
        vacationType: "sick leave", vacationStatus :"Pending", vacationReason: "",
        vacationStart: today,
        vacationEnd: today,
        daysCount: 1,
        ...
        <div className='fixed inset-0 bg-opacity-50 flex items-center justify-center shadow-lg/10 z-50' style={{ backgroundColor: 'rgba(20, 10, 10, 0.4)' }}>
            ...
            >
                ...
                <div className="flex justify-between items-center mb-4 shadow-xl p-2">
                    <h2 className='text-amber-900 text-sm font-semibold'>Sick leave requirement</h2>
...
export default VacationSickleaveAdd ;