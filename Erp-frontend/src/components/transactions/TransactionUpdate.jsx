                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className='text-blue-100 text-xs sm:text-sm'>Modify transaction details</p>
                            </div>
                        </div>
                        <button 
                            onClick={handleClose}
...
//         refrence: transaction.refrence,
//         description: transaction.description,
//         paymentMethod: transaction.paymentMethod || "Cash", // Add paymentMethod with default
//         status: 'updated'
//     });
...
//                     <h2 className='text-[#1a1a1a] text-md font-bold'>Update Transaction</h2>
...
//                 {/* Modal Body */}
//                 <form className='mt-3 space-y-6 p-2' onSubmit={onSubmitHandler}>
//                     {/* Type Radio Buttons */}
//                     <div className='flex items-center justify-between'>
...
//                     {/* Reference */}
//                     <div className='flex items-center justify-between'>
//                         <label className='w-[25%] text-[#1a1a1a] block text-xs font-normal'>Reference :</label>
//                         <div className='flex w-[75%] items-center rounded-xs p-3 bg-white shadow-xl'>
//                             <input
//                                 type='text'
//                                 name='refrence'
